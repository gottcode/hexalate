...
!define MUI_ICON "..\icons\hexalate.ico"
!define MUI_UNICON "..\icons\hexalate.ico"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\Hexalate.exe"
...
Section "install"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$\"$INSTDIR\Hexalate.exe$\""
	...
	CreateShortCut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "$INSTDIR\Hexalate.exe"
